...
echo form_open_multipart(base_url('admin/partner/tambah'));
?>

<div class="col-md-6">
	<div class="form-group form-group-lg">
		<label>Nama partner</label>
			<input type="text" name="nama" class="form-control" placeholder="Nama Partner" value="<?php echo set_value('nama')?>" required>
	</div>
