...
echo form_open_multipart(base_url('admin/slider/tambah'));
?>

<div class="col-md-6">
	<div class="form-group form-group-lg">
		<label>Nama Slider</label>
			<input type="text" name="nama" class="form-control" placeholder="Nama Slider" value="<?php echo set_value('nama')?>" required>
	</div>
